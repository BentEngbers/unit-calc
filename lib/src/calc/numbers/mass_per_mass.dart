...
class MassPerMass implements Number {
  ...
  const MassPerMass(this._value, this.massUnit, this.perMassUnit)
    : assert(_value >= 0);

  const MassPerMass.perKg(this._value, this.massUnit)
  ...
  MassPerMass as({MassUnit? massUnit, MassUnit? perMassUnit}) => _toMassUnit(
